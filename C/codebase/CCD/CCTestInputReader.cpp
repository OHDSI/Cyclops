...
//	cout << "Sum of exposed: " << std::accumulate(data[0]->begin(), data[0]->end(), static_cast<bsccs::real>(0.0)) << endl;
//	cout << "Sum of count  : " << std::accumulate(data[1]->begin(), data[1]->end(), static_cast<bsccs::real>(0.0)) << endl;
